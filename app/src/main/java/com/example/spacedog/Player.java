...
//    private void rotateAniimation(){
//
//        TranslateAnimation slide = new TranslateAnimation(view.getX(), view.getX()  + 100, view.getY(), view.getY()  + 100 );
//        slide.setDuration(1000);
//        view.startAnimation(slide);
//
//        ObjectAnimator animator = ObjectAnimator.ofFloat(bitmap,"rotation",360).setDuration(1500);
//        animator.start();
//
//        animator = ObjectAnimator.ofFloat(bitmap,"alpha",0.5f).setDuration(1000);
//        animator.start();
//    }
